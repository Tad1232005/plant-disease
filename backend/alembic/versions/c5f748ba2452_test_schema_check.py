...
Revision ID: c5f748ba2452
Revises: 
Create Date: 2026-08-17 16:34:44.622295
...
def upgrade() -> None:
    ...
    op.execute("""
        CREATE UNIQUE INDEX idx_single_active_model
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.execute("DROP INDEX IF EXISTS idx_single_active_model")
